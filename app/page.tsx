...
import { 
  ...
  Shield, Sparkles, Gift, X, Map, ExternalLink, Wine, Home, CalendarDays,
  Utensils, UsersRound, Trees, Mountain, Castle, Thermometer, Waves, Clock4,
...
export default function HotelKronePremium() {
  ...
  return (
    <div className="min-h-screen bg-[#fafaf9]">
            ...
            <SheetContent side="right" className="w-full sm:w-96">
              ...
              <div className="flex flex-col gap-6 mt-10">
                ...
                <Button 
                  ...
                  className="w-full bg-[#78350f] hover:bg-[#5d2809] rounded-full"
                >
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <Image 
            ...
            alt="Hotel Krone Großsachsen - Ihr Hotel an der Bergstraße" 
            fill 
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 text-center text-white">
          <Badge className="mb-6 bg-white/20 text-white border-white/30 backdrop-blur-sm px-5 py-2 text-sm tracking-widest uppercase">
          ...
          <p className="text-2xl md:text-3xl lg:text-4xl font-light mb-6 text-white/95 max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            <Button 
              size="lg" 
              onClick={() => setBookingOpen(true)}
              className="bg-white text-[#78350f] hover:bg-white/90 rounded-full px-10 py-7 text-lg font-semibold shadow-2xl"
            >
              <Calendar className="w-5 h-5 mr-2" />
              Zimmer buchen
            </Button>
            <Button 
              ...
              variant="outline" 
              className="border-white text-white hover:bg-white/10 rounded-full px-10 py-7 text-lg font-semibold"
            >
      ...
      <section className="bg-[#78350f] text-white py-10">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              { icon: Wifi, label: "Highspeed WLAN", sub: "Kostenlos im ganzen Haus" },
              { icon: Car, label: "80 Parkplätze", sub: "Inklusive & überdacht" },
              { icon: Zap, label: "2 E-Ladestationen", sub: "Für Ihr E-Auto" },
              { icon: Coffee, label: "Frühstücksbuffet", sub: "Reichhaltig & regional" },
            ].map((f) => (
      ...
      <section id="zimmer" className="py-28 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-20">
            ...
            <h2 className="font-serif text-5xl md:text-6xl lg:text-7xl font-bold text-stone-900 mb-6">
            ...
            <Card className="overflow-hidden group border-0 shadow-2xl hover:shadow-3xl transition-shadow duration-500">
              <div className="relative h-[450px] overflow-hidden">
                <Image 
                  ...
                  alt="Einzelzimmer Hotel Krone Großsachsen" 
                  fill 
              ...
              <CardContent className="p-10">
                ...
                <ul className="space-y-4 mb-8">
                  {[
                    ...
                    "Flatscreen TV mit Sky",
                    "Kostenloses Highspeed WLAN",
                    "Schreibtisch & Direktwahltelefon",
                    "Haartrockner & Kosmetikspiegel"
                  ].map((a) => (
                    <li key={a} className="flex items-center text-stone-700 text-lg">
                ...
                <div className="bg-amber-50 border border-amber-200 rounded-xl p-5 mb-8">
                  <p className="text-amber-900 flex items-start">
                    ...
                    <span>Kostenfreie Stornierung bis 18:00 am Anreisetag bei Direktbuchung!</span>
                  </p>
                </div>
                <Button 
                  onClick={() => {setActiveRoom("einzel"); setBookingOpen(true);}}
                  className="w-full bg-[#78350f] hover:bg-[#5d2809] rounded-full py-7 text-lg font-semibold"
                >
                  Jetzt anfragen
            ...
            <Card className="overflow-hidden group border-0 shadow-2xl ring-2 ring-[#78350f] hover:shadow-3xl transition-shadow duration-500">
              <div className="relative h-[450px] overflow-hidden">
                <Image 
                  ...
                  alt="Doppelzimmer Hotel Krone Großsachsen" 
                  fill 
                  className="object-cover transition-transform duration-700 group-hover:scale-105" 
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent" />
                <div className="absolute top-6 right-6">
                  <Badge className="bg-[#78350f] text-white px-4 py-1.5 text-sm">Beliebt</Badge>
                </div>
                <div className="absolute bottom-8 left-8 right-8 text-white">
                  <Badge className="bg-white/20 text-white border-white/30 mb-4 backdrop-blur-sm">
                    Für 2 Personen
              ...
              <CardContent className="p-10">
                ...
                <div className="bg-green-50 border border-green-200 rounded-xl p-5 mb-8">
                  <p className="text-green-900 flex items-start">
                    <Gift className="w-5 h-5 mr-3 flex-shrink-0 mt-0.5" />
                    <span className="font-semibold">Direkt buchen und 10% sparen!</span>
                  </p>
                </div>
                <Button 
                  onClick={() => {setActiveRoom("doppel"); setBookingOpen(true);}}
                  className="w-full bg-[#78350f] hover:bg-[#5d2809] rounded-full py-7 text-lg font-semibold"
                >
                  Jetzt anfragen
                  <ArrowRight className="w-5 h-5 ml-2" />
      ...
      {/* RESTAURANT SECTION */}
      <section id="restaurant" className="py-28 bg-stone-100">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <Badge variant="outline" className="mb-4 text-[#78350f] border-[#78350f] px-4 py-1">Gastronomie</Badge>
              <h2 className="font-serif text-5xl md:text-6xl font-bold text-stone-900 mb-8">
                Kulinarische<br />Genussmomente
              </h2>
              <p className="text-xl text-stone-600 mb-10 leading-relaxed">
                Regionale Küche trifft auf moderne Interpretation. Unser Küchenchef 
                verwöhnt Sie mit saisonalen Spezialitäten aus der Region und erlesenen Weinen.
              </p>

              <Card className="mb-10 border-0 shadow-xl">
                <CardContent className="p-8">
                  <div className="flex items-center gap-3 mb-6">
                    <Clock className="w-7 h-7 text-[#78350f]" />
                    <h4 className="font-semibold text-xl">Öffnungszeiten Restaurant</h4>
                  </div>
                  <div className="space-y-4">
                    <div className="flex justify-between items-center py-3 border-b border-stone-100">
                      <span className="font-semibold text-red-600">Montag & Dienstag</span>
                      <span className="text-red-600 font-semibold">Ruhetag</span>
                    </div>
                    <div className="flex justify-between items-center py-3 border-b border-stone-100">
                      <span className="text-stone-700 font-medium">Mittwoch & Donnerstag</span>
                      <span className="text-stone-600">Abends: 17:30 - 22:00 Uhr</span>
                    </div>
                    <div className="flex justify-between items-center py-3">
                      <span className="text-stone-700 font-medium">Freitag - Sonntag</span>
                      <span className="text-stone-600">Mittags: 11:30 - 14:30 Uhr<br/>Abends: 17:30 - 22:00 Uhr</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <div className="grid grid-cols-2 gap-5 mb-10">
                {[
                  { icon: UtensilsCrossed, title: "Regionale Küche", desc: "Saisonal & frisch zubereitet" },
                  { icon: WineIcon, title: "Weinkarte", desc: "Regionale Weine & internationale Klassiker" },
                  { icon: PartyPopper, title: "Events", desc: "Weinabende & Themenabende" },
                  { icon: Gift, title: "Raummiete", desc: "Keine Miete bei Veranstaltungen" },
                ].map((item) => (
                  <div key={item.title} className="flex items-start gap-4">
                    <div className="w-12 h-12 rounded-full bg-[#78350f]/10 flex items-center justify-center flex-shrink-0">
                      <item.icon className="w-6 h-6 text-[#78350f]" />
                    </div>
                    <div>
                      <div className="font-semibold text-stone-900 text-lg">{item.title}</div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button 
                  size="lg" 
                  onClick={() => setReservationOpen(true)}
                  className="bg-[#78350f] hover:bg-[#5d2809] rounded-full px-8 py-6 text-lg"
                >
                  <Calendar className="w-5 h-5 mr-2" />
                  Tisch reservieren
                </Button>
                <Button 
                  size="lg" 
                  variant="outline" 
                  className="rounded-full px-8 py-6 text-lg border-[#78350f] text-[#78350f] hover:bg-[#78350f] hover:text-white"
                >
                  <UtensilsCrossed className="w-5 h-5 mr-2" />
                  Speisekarte ansehen
                </Button>
            ...
            <div className="grid grid-cols-2 gap-5">
              <div className="space-y-5">
                <div className="relative h-60 rounded-3xl overflow-hidden shadow-xl">
                  <Image src="/images/hotel/restaurant-1.jpg" alt="Restaurant Ambiente" fill className="object-cover" />
                </div>
                <div className="relative h-80 rounded-3xl overflow-hidden shadow-xl">
                  <Image src="/images/hotel/food-1.jpg" alt="Kulinarische Spezialitäten" fill className="object-cover" />
                </div>
              </div>
              <div className="space-y-5 pt-10">
                <div className="relative h-80 rounded-3xl overflow-hidden shadow-xl">
                  <Image src="/images/hotel/restaurant-2.jpg" alt="Restaurant" fill className="object-cover" />
                </div>
                <div className="relative h-60 rounded-3xl overflow-hidden shadow-xl">
                  <Image src="/images/hotel/restaurant-3.jpg" alt="Gemütliche Atmosphäre" fill className="object-cover" />
                </div>
              </div>
            </div>
          </div>
